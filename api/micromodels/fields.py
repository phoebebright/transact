...
class ModelField(WrappedObjectField):
    ...
    def to_serial(self):
        return self.data.to_dict(serial=True)
...
class ModelCollectionField(WrappedObjectField):
    ...
    def to_serial(self):
        return [instance.to_dict(serial=True) for instance in self.data]
...
class FieldCollectionField(BaseField):
    ...
    def to_serial(self):
        return [self._instance.to_serial() for data in self.data]
